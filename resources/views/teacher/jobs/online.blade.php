...
<head>
    ...
    <title>Online Jobs - TuitionFinder</title>
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <p>Find online teaching opportunities that match your expertise</p>
        </div>

        <div class="filters">
            <form method="GET" action="{{ route('teacher.jobs.online') }}">
        ...
        @empty
            <div class="no-jobs">
                <i class="fas fa-laptop" style="font-size: 48px; margin-bottom: 16px; color: #d1d5db;"></i>
                <h3>No online jobs found</h3>
